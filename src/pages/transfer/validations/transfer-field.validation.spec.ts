...
describe("transfer-field.validations specs", () => {
  ...
  describe("validateAccountIdField", () => {
    it("should return true when accountId is informed", () => {
      // Arrange
      const value = "2";
      // Act
    ...
    it("should return false when accountId is not informed", () => {
      // Arrange
      const value = "";
      // Act
      const result = validateAccountIdField(value);
  ...
  describe("validationIBANField", () => {
    ...
    it("should return false when iban is not well formed", () => {
      // Arrange
      const value = "ES91 2100 0418 4502 0005 1333";
      // Act
      const result = validateIBANField(value);
      // Assert
      expect(result.succeeded).toBeFalsy();
